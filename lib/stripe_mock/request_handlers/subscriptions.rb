  ...
  module RequestHandlers
    module Subscriptions
      ...
      def create_subscription(route, method_url, params, headers)
        ...
        subscription = Data.mock_subscription({ id: (params[:id] || new_id('sub')), description: params[:description] })
        subscription = resolve_subscription_changes(subscription, subscription_prices, customer, params)
        ...
        invoice = Stripe::Invoice.create(subscription: subscription[:id], payment_intent: payment_intent)
